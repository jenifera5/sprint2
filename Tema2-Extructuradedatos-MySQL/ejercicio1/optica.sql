...
CREATE TABLE IF NOT EXISTS `mydb`.`Cliente` (
  ...
  `id_recomendado_por` VARCHAR(15) NULL,
  PRIMARY KEY (`id_cliente`),
  INDEX `id_recomendado_por_idx` (`id_cliente` ASC, `id_recomendado_por` ASC) VISIBLE,
  CONSTRAINT `id_recomendado_por`
    FOREIGN KEY (`id_cliente` , `id_recomendado_por`)
    REFERENCES `mydb`.`Cliente` (`id_cliente` , `id_cliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
